...
class Demand {
    ...
    public function sendData($conn,$matricule,$data)
    {
      try {
        ...
        $sql = "insert into demand (etudiant_matricule,etudiant_first_name,etudiant_last_name,etudiant_place_of_birth,etudiant_date_of_birth,etudiant_year,type_of_document,date)
                  values  (:etudiant_matricule,:etudiant_first_name,:etudiant_last_name,:etudiant_place_of_birth,:etudiant_date_of_birth,:etudiant_year,:type_of_document,current_date )
